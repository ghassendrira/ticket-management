  ...
  template: `
    <nav class="navbar" [class.scrolled]="isScrolled">
      <div class="navbar-container">
        <a routerLink="/" class="navbar-logo">Triage</a>
        ...
        <div class="navbar-actions">
          ...
          <button class="theme-toggle" (click)="themeService.toggleTheme()" aria-label="Changer de thème">
          ...
          @if (!authService.isAuthenticated()) {
            <a routerLink="/login" class="btn btn-secondary">{{ 'AUTH.LOGIN.LABEL' | translate }}</a>
          } @else {
            <button class="btn btn-secondary" (click)="authService.logout()">{{ 'AUTH.LOGOUT' | translate }}</button>
